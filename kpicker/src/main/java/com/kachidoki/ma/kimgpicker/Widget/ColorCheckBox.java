...
public class ColorCheckBox extends View implements Checkable, View.OnClickListener {
    ...
    public void setUserListener(OnClickListener listener){
    ...
    public ColorCheckBox(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.ColorCheckBox);
        size = ta.getDimensionPixelSize(R.styleable.ColorCheckBox_size, dp(size));
        bitmapColor = ta.getColor(R.styleable.ColorCheckBox_color_background, bitmapColor);
        borderColor = ta.getColor(R.styleable.ColorCheckBox_color_border, borderColor);
    ...
    public void onClick(View v) {
        toggle();
        if (userListener!=null) userListener.onClick(v);
    }
}